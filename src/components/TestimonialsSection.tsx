...
const TestimonialsSection = () => {
    ...
    return (
        <section ref={sectionRef} className="relative bg-white py-20 overflow-hidden">
            {/* Background Icons */}
            <div className="absolute top-10 left-10 opacity-10 text-[#CB3A1A] w-24 h-24 rotate-[-15deg]" aria-hidden="true">
                <GarlicIcon className="w-full h-full" />
            </div>
            <div className="absolute top-10 right-10 opacity-10 text-[#CB3A1A] w-24 h-24 rotate-[15deg]" aria-hidden="true">
                <MuffinIcon className="w-full h-full" />
            </div>
            <div className="absolute bottom-10 left-10 opacity-10 text-[#CB3A1A] w-24 h-24 rotate-[15deg]" aria-hidden="true">
                <BurgerIcon className="w-full h-full" />
            </div>
            <div className="absolute bottom-10 right-10 opacity-10 text-[#CB3A1A] w-24 h-24 rotate-[-15deg]" aria-hidden="true">
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="testimonial-header text-center mb-16">
                    ...
                    <div className="flex justify-center gap-1 text-[#CB3A1A]" aria-hidden="true">
                        <span>♦</span>
                        <span>♦</span>
                        <span>♦</span>
                        <span>♦</span>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    {testimonials.map((testimonial) => (
                        <article key={testimonial.id} className="testimonial-card bg-[#F9F9F9] p-8 md:p-12 border border-red-100 relative group hover:shadow-lg transition-shadow">
                            <blockquote className="text-gray-600 leading-relaxed mb-8 text-sm md:text-base">
                                "{testimonial.text}"
                            </blockquote>
                            ...
                            {/* Quote Icon */}
                            <div className="absolute bottom-8 right-8 text-red-100" aria-hidden="true">
