...
const SocialIcon = ({ path }: { path: string }) => (
    <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white flex items-center justify-center hover:bg-[#CB3A1A] hover:text-white transition-colors text-black">
...
const Footer = () => {
    ...
    return (
        <footer ref={footerRef} className="bg-[#0B0B0B] text-white pt-16 md:pt-20 pb-8 md:pb-10 relative overflow-hidden">
            {/* Background Texture Overlay */}
            <div className="absolute inset-0 opacity-5 pointer-events-none"
                style={{ backgroundImage: 'url("https://www.transparenttextures.com/patterns/cubes.png")' }}>
            </div>

            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 relative z-10">
                {/* Column 1: Get in Touch */}
                <div className="footer-column">
                    <h3 className="text-base md:text-lg font-bold uppercase mb-6 md:mb-8 border-b border-gray-800 pb-2 inline-block">
                        Get in Touch
                    </h3>
                    <div className="space-y-3 md:space-y-4 text-gray-400 text-xs sm:text-sm">
                ...
                <div className="footer-column">
                    ...
                    <ul className="space-y-3 md:space-y-4 text-gray-400 text-xs sm:text-sm">
                ...
                <div className="footer-column">
                    ...
                    <div className="space-y-3 md:space-y-4 text-gray-400 text-xs sm:text-sm">
                        ...
                        <p className="text-[#CB3A1A] mt-4 md:mt-6 text-[10px] sm:text-xs">* Happy hour 17:00 - 21:00</p>
                    </div>
                </div>
            ...
            {/* Copyright */}
            <div className="max-w-7xl mx-auto px-4 mt-12 md:mt-16 pt-6 md:pt-8 border-t border-gray-900 text-center text-gray-600 text-xs sm:text-sm">
